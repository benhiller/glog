...
- Autoscroll doesn't consistently get enabled when scrolling to bottom
- Get rid of colors which have white text on colored background (more generally use my color settings?)
